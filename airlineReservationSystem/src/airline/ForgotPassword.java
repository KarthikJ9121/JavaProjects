...
public class ForgotPassword extends JFrame implements ActionListener {
    ...
    public ForgotPassword() {
        ...
        b2.setBounds(200, 350, 150, 40); // Set bounds
        ...
        backButton.setBounds(400, 350, 150, 40); // Set bounds
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b2) {
            try {
                try {
                    DbConn c = new DbConn();
                    String str1 = "SELECT COUNT(*) AS count FROM passengerlogin WHERE username = ?";
                    ...
                    if (count > 0) {
                        ...
                        if (!password.equals(password1) || password.isEmpty() || password1.isEmpty()) {
                            ...
                            try {
                                ...
                                String updateQuery = "UPDATE passengerlogin SET password = ? WHERE username = ?";
            ...
            new PassengerLogin(); // Assuming PassengerLogin is the class name for the passenger login page
