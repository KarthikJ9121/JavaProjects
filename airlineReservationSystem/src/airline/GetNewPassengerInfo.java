...
public class GetNewPassengerInfo {
    ...
    public static GetNewPassengerInfo getPassengerDataFromDB(String passengerNumber) {
        
         GetNewPassengerInfo passenger = new GetNewPassengerInfo();
